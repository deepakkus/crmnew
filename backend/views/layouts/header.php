...
<header class="main-header">
        ...
        <a href="<?php echo Yii::$app->homeUrl;?>dashboard/index" class="logo">
          ...
          <span class="logo-mini"><p style="font-weight:900; font-size:22px">OL</p></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img class="img-responsive" src="../images/OL-Logo.png" width="60%"></span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <p class="wlcTxt"><span>CRM Admin </span></p>
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <?php if((Yii::$app->user->identity) && Yii::$app->user->identity->image_id !== ''){?>
